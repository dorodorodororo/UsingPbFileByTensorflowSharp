...
namespace TensorflowSharp_Inception_Final
{

    public partial class TensorflowSharp_Inception_Final_1
    {
        public TensorflowSharp_Inception_Final_1()
        {
            //InitializeComponent();
        }
        ...
        public void Run()
        {
            string filepath = @"C:\Users\김도원\source\repos\TensorflowSharp_Inception_Final\imagemodel\jazz00090.jpg";
            string InputFileName = Path.GetFileName(filepath);
            Console.WriteLine(InputFileName);
            Inference(InputFileName);
        }
        /// <summary>
        ...
        */
        ...
        {
            ModelFiles(@"C:\Users\김도원\source\repos\TensorflowSharp_Inception_Final\model");
